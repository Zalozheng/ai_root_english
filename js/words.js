document.addEventListener('DOMContentLoaded', () => {
    ...
    window.triggerWordFilter = function() {
    ...
    if(document.getElementById('word-search')) {
        document.getElementById('word-search').addEventListener('input', window.triggerWordFilter);
        document.getElementById('word-sort').addEventListener('change', window.triggerWordFilter);
        if(document.getElementById('word-context-filter')) {
            document.getElementById('word-context-filter').addEventListener('change', window.triggerWordFilter);
        }
    }
